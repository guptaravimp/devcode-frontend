        ...
        <div className='p-5'>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className='mt-6 flex flex-col items-center' >
            ...
            <div className='flex w-11/12 flex-col space-y-2'>
              ...
              <textarea {...register("userExperience", { required: true })} className='form-style resize-x-none bg-richblack-700 rounded-xl p-4 text-richblack-100 text-xl min-h-[130px] w-full' placeholder='Write your experience...'></textarea>
