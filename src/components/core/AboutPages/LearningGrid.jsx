...
// import HomeButton from '../HomePages/HomeButton';
...
//     return (
//         <div className=' mx-auto w-[70%] grid grid-col-1 lg:grid-cols-4 mb-10'>
//             {
//                 LearningGridArray.map((card, index) => {
//                     return (
//                         <div key={index} className={`${index===0  && "lg:col-span-2"} ${card.order%2===1 ?"bg-richblack-700" :"bg-richblack-800 "}
...
//                                 <HomeButton active={true} linkto={card.BtnLink}>{card.BtnText}</HomeButton>
//                                 </div>):(<div>
//                                     <h1>{card.heading}</h1>
