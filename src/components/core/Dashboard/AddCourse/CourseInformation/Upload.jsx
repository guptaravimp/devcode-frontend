                ...
                image ? (
                    ...
                    <div className="flex flex-col space-y-2">
                        <label className="text-sm text-richblack-5" htmlFor={label}>
                            ...
                            <div className="bg-richblack-700 flex min-h-[250px] mt-3 cursor-pointer items-center justify-center rounded-md border-2 border-dotted border-richblack-500">
                                <div
                                ...
                                >
                                    ...
                                    <div className="grid aspect-square mt-4 w-14 place-items-center rounded-full bg-pure-greys-800">
                                        <svg
                                            stroke="currentColor"
                                            fill="none"
                                            strokeWidth="2"
