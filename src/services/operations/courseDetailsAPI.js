...
export const getAllCourses = async () => {
  ...
  let result = [];
  try {
    const response = await apiconnectorr("GET", GET_ALL_COURSE_API);
...
export const fetchCourseDetails = async (courseId) => {
  ...
  console.log("course id is ye hai guru", courseId)
  let result = null;
  try {
...
export const fetchCourseCategories = async () => {
  ...
  try {
    ...
    console.log("COURSE_CATEGORIES_API API RESPONSE............", response?.data?.allTags);
    if (!response?.data?.success) {
      throw new Error("Could Not Fetch Course Categories");
    }
...
export const fetchInstructorCourses = async (token) => {
  ...
  const toastId = toast.loading("Loading...")
  try {
    // console.log("Instructorr api is ",GET_ALL_INSTRUCTOR_COURSES_API)
    console.log("token is here bro",token)
